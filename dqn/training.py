# DEPRECATED: DQN training is deprecated - use only for evaluation
import random
import numpy as np
...
import os
from utils.create_strategy_bots import load_strategy_bots, create_all_strategy_bots
...
def hyperparameter_tuning(num_configs=5, episodes_per_config=200, eval_games=50, num_players=4):
    """DEPRECATED: Automatically tune hyperparameters using self-play training
    
    WARNING: DQN training is deprecated. Use CFR (cfr.train_cfr_ai) or DeepCFR instead.
    This function is kept only for evaluation compatibility with existing models.
    """
    print("=" * 60)
    print("⚠️  WARNING: DQN TRAINING IS DEPRECATED")
